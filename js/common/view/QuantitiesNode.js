...
define( require => {
  ...
  // strings
  const leftoversString = require( 'string!REACTANTS_PRODUCTS_AND_LEFTOVERS/leftovers' );
  const productsString = require( 'string!REACTANTS_PRODUCTS_AND_LEFTOVERS/products' );
